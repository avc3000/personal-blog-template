  ...
  return (
    <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between">
      ...
      <nav className="w-max py-3 px-6 sm:px-8 border border-solid border-dark rounded-full font-medium capitalize items-center flex sm:hidden fixed top-6 right-1/2 translate-x-1/2 bg-light/80 backdrop-blur-sm z-50 transition-all ease duration-300" style={{ top: click ? "1rem" : "-5rem" }}>
        <Link href="/" className="mr-2 bg-gradient-to-r from-dark to-dark bg-[length:0px_6px] hover:font-bold hover:bg-[length:100%_2px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500">Home</Link>
        <span className="mr-1">|</span><Link href="/about" className="mx-2 bg-gradient-to-r from-dark to-dark bg-[length:0px_6px] hover:font-bold hover:bg-[length:100%_2px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500">Perfil</Link><span className="ml-1">|</span>
        <Link href="/contact" className="mx-2 bg-gradient-to-r from-dark to-dark bg-[length:0px_6px] hover:font-bold hover:bg-[length:100%_2px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500">Contacto</Link>
